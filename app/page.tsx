        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={index}
                className="group bg-white/5 hover:bg-white/10 backdrop-blur-sm rounded-3xl p-6 transition-all duration-300 hover:translate-y-[-8px]"
              >
            ...
            {[
              {
                ...
                description: "Get legal insights in simple terms, no confusing jargon.",
              ...
              
              {
                ...
                description: "Ensure your documents and contracts are legally sound.",
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-3xl p-8 transition-all duration-300 hover:translate-y-[-8px]"
              >
